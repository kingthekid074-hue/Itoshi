...
local GamesGroup = Tabs.Games:AddLeftGroupbox("Game Features")
local SettingsGroup = Tabs.Settings:AddLeftGroupbox("Settings")
local KillauraGroup = Tabs.Killaura:AddLeftGroupbox("Killaura Features")
...
MainGroup:AddSlider("FOVChanger", {
    Text = "FOV Changer",
    Min = 30,
    Max = 120,
    Default = 70,
...
MainGroup:AddToggle("ImprovedKillaura", {
...
MainGroup:AddSlider("HeadSizeMultiplier", {
...
MainGroup:AddSlider("HitboxMultiplier", {
...
MainGroup:AddToggle("Invisibility tp", {
    Text = "Invisibility tp",
    Default = false,
    Callback = function(Value)
...
MainGroup:AddToggle("Desync", {
    Text = "Desync (Anti-Hit)",
    Default = false,
    Callback = function(Value)
        PastedSources = Value
        if Value then
            Notification("Desync Enabled - Use X to toggle", 3)
        else
            Notification("Desync Disabled", 3)
        end
    end
})

MainGroup:AddToggle("Hitbox expander v2", {
    Text = "v2",
    Default = false,
    Callback = function(Value)
...
MainGroup:AddInput("Hitbox v2 size", {
    Text = "Hitbox Range",
    Default = "30",
    Placeholder = "30",
    Callback = function(Value)
...
MainGroup:AddToggle("AutoAttack", {
    Text = "⚔️ Auto Attack",
    Default = false,
    Callback = function(Value)
...
MainGroup:AddToggle("SmartAutoAttack", {
...
MainGroup:AddToggle("KillauraRage", {
    Text = "🔁 KILLAURA RAGE",
    Default = false,
    Callback = function(Value)
                ...
                if currentAimTarget and currentAimTarget.Character then
                    ...
                    if targetRoot then
                        ...
                        if directionToTarget.Magnitude > 0 then
                            ...
                            local targetCFrame = CFrame.new(rootPart.Position, rootPart.Position + directionToTarget)
...
MainGroup:AddInput("RotationSpeed", {
    Text = "Rotation Speed",
    Default = "0.15",
    Placeholder = "0.15",
    Callback = function(Value)
...
MainGroup:AddButton("CustomEmotes", {
    Text = "Custom Emotes",
    Func = function()
...
MainGroup:AddButton("CustomEmotes2", {
    ...
    Func = function()
        ...
        local function showNotification(message)
            ...
            game:GetService("TweenService"):Create(notificationFrame, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0}):Play()
            game:GetService("TweenService"):Create(textLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
            task.delay(5, function()
                game:GetService("TweenService"):Create(notificationFrame, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {BackgroundTransparency = 1}):Play()
                game:GetService("TweenService"):Create(textLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {TextTransparency = 1}):Play()
...
MainGroup:AddDropdown("SelectTool1", {
    Text = "Select Tool 1",
...
MainGroup:AddDropdown("SelectTool2", {
    Text = "Select Tool 2",
    Values = Custom_PowerTools,
    Default = "Oblivious",
    Callback = function(Value)
...
MainGroup:AddInput("CustomPowersName", {
...
MainGroup:AddButton("EquipCustomPower", {
...
MainGroup:AddButton("LightningGodAwakening", {
...
MainGroup:AddButton("EnableDash", {
    Text = "Enable Dash",
    Func = function()
...
MainGroup:AddButton("StrengthBoost", {
    Text = "Strength Boost",
    Func = function()
...
MainGroup:AddButton("EquipPhantomStep", {
...
MainGroup:AddButton("RemovePower", {
    Text = "Remove Power",
    Func = function()
...
MainGroup:AddButton("EnablePowers", {
    Text = "Enable Powers",
    Func = function()
...
MainGroup:AddButton("EnableAllGamepasses", {
...
MainGroup:AddButton("SelectFork", {
    Text = "Select Fork",
    Func = function()
...
MainGroup:AddButton("ShowAllButtons", {
...
MainGroup:AddButton("UnlockVIPFeatures", {
...
MainGroup:AddDropdown("PlayerSelector", {
...
MainGroup:AddButton("RefreshPlayers", {
...
MainGroup:AddButton("TeleportToSelectedPlayer", {
...
MainGroup:AddToggle("AttachToPlayer", {
...
MainGroup:AddButton("TeleportToRandomPlayer", {
...
MainGroup:AddInput("NOTBOTCommand", {
    Text = "NOTBOT Command",
    Default = "",
...
MainGroup:AddButton("FindKillauras", {
    Text = "Find Killauras",
    Func = function()
...
MainGroup:AddButton("NOTBOTHelp", {
    Text = "NOTBOT Help",
    Func = function()
...
MovementGroup:AddToggle("Quicksilver", {
    Text = "Quicksilver",
    Default = false,
    Callback = function(Value)
...
MovementGroup:AddToggle("Invisibility", {
    ...
    Callback = function(Value)
        ...
        if Value then
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                ...
                character.HumanoidRootPart.CFrame = CFrame.new(OriginalPosition.X, OriginalPosition.Y - 45, OriginalPosition.Z)
                ...
                InvisibilityConnection = RunService.Heartbeat:Connect(function()
                    ...
                    if character and character:FindFirstChild("HumanoidRootPart") then
                        ...
                        if currentPos.Y > OriginalPosition.Y - 40 then
                            character.HumanoidRootPart.CFrame = CFrame.new(currentPos.X, OriginalPosition.Y - 45, currentPos.Z)
                        end
...
MovementGroup:AddToggle("ImprovedAntiFall", {
...
MovementGroup:AddToggle("AntiFall", {
    Text = "Anti Fall",
    Default = false,
    Callback = function(Value)
...
MovementGroup:AddButton("TeleportToSpawn", {
...
MovementGroup:AddButton("TeleportToSafeSpot", {
...
MovementGroup:AddToggle("AutoSkip", {
    Text = "AUTO SKIP",
    Default = false,
    Callback = function(Value)
...
MiscGroup:AddToggle("TeleportPlayer", {
...
MiscGroup:AddToggle("CamlockPlayer", {
...
MiscGroup:AddToggle("AutoCollectBandage", {
...
MiscGroup:AddToggle("AutoCollectFlashBang", {
...
MiscGroup:AddToggle("AutoCollectGrenade", {
...
MiscGroup:AddToggle("EspHighlight", {
...
MiscGroup:AddColorPicker("ColorEsp", {
    Text = "Color Esp",
...
MiscGroup:AddColorPicker("ColorEspText", {
    Text = "Color Esp Text",
    Default = Color3.fromRGB(255, 255, 255),
    Callback = function(Value)
...
MiscGroup:AddSlider("TextSizeGui", {
    Text = "Text Size [ Gui ]",
    Min = 7,
    Max = 50,
    Default = 7,
...
MiscGroup:AddToggle("EspDistance", {
    Text = "Esp Distance",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("ESPCandies", {
    Text = "ESP Candies",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("AutoFarmCandies", {
...
GamesGroup:AddToggle("ESPHalloweenDoors", {
...
GamesGroup:AddButton("TPtoHalloweenDoors", {
...
GamesGroup:AddToggle("RLGLBypass", {
    Text = "🟢 RLGL Bypass",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("RLAutoStop", {
    Text = "RLGL Auto-Stop",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddDropdown("RLGLMode", {
    Text = "RLGL Mode",
...
GamesGroup:AddButton("ModeRandomPlayer", {
...
GamesGroup:AddButton("DestroyInjuredStun", {
...
GamesGroup:AddButton("TPSAFEPLACE", {
    Text = "TP SAFE PLACE",
    Func = function()
...
GamesGroup:AddButton("AutoCookie", {
    Text = "Auto Cookie",
    Func = function()
...
GamesGroup:AddButton("FREELIGHTER", {
    Text = "FREE LIGHTER",
    Func = function()
        local function setAttributeSafe(instance, name, value)
            if instance:GetAttribute(name) == nil then
...
GamesGroup:AddButton("REMOVEPHOTOWALL", {
...
GamesGroup:AddToggle("Anti fall (Patched) ", {
    Text = "Anti-Fall Platform (Patched)",
    Default = false,
    Callback = function(Value)
        if Value then
...
GamesGroup:AddToggle("ESPSeekers", {
    Text = "ESP Seekers",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("ESPHiders", {
    Text = "ESP Hiders",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("ESPExitDoor", {
    Text = "ESP Exit Door",
    Default = false,
    Callback = function(Value)
        if Value then
...
GamesGroup:AddButton("HNSESPExit", {
    Text = "HNS - ESP Exit",
    Func = function()
...
GamesGroup:AddButton("HNSDeleteTheSpikes", {
...
GamesGroup:AddButton("REMOVESPIKE", {
    Text = "REMOVE SPIKE",
    Func = function()
        local count = 0
        for _, obj in ipairs(workspace:GetDescendants()) do
...
GamesGroup:AddToggle("DefensiveSpikeRemoval", {
                ...
                if currentHealth < _G.DefensiveLastHealth and currentHealth > 0 then
                    if killingPartsPosition then
                        ...
                        spawn(function()
                            ...
                            local TweenService = game:GetService("TweenService")
                            local expandTween = TweenService:Create(escapePulse, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = Vector3.new(15, 15, 15), Transparency = 1})
                            expandTween:Play()
...
GamesGroup:AddToggle("TpHidersToSpikes", {
                        ...
                        if currentTime - lastOffensiveTPTime >= offensiveTPCooldown then
                            if offensiveKillingPartsPosition then
                                ...
                                spawn(function()
                                    ...
                                    local TweenService = game:GetService("TweenService")
                                    local expandTween = TweenService:Create(attackFlash, TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = Vector3.new(20, 20, 20), Transparency = 1})
                                    expandTween:Play()
...
GamesGroup:AddToggle("AutoKillHide", {
    Text = "AUTO KILL HIDE",
    Default = false,
    Callback = function(Value)
        ...
        if AutoKillEnabled then
            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if targetPlayer and targetPlayer.Character then
                    local targetTorso = targetPlayer.Character:FindFirstChild("HumanoidRootPart") or targetPlayer.Character:FindFirstChild("UpperTorso")
                    if targetTorso then
...
GamesGroup:AddToggle("AutoDodgeHNS", {
    Text = "Auto Dodge HNS",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddButton("TPEXITDOOR", {
    Text = "TP EXIT DOOR",
    Func = function()
...
GamesGroup:AddToggle("SpikeKill", {
    Text = "Spike Kill",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("TugOfWarAuto", {
...
GamesGroup:AddButton("JumpRopeTeleportToEnd", {
...
GamesGroup:AddButton("JumpRopeDeleteTheRope", {
...
GamesGroup:AddButton("REMOVEROPE", {
    Text = "REMOVE ROPE",
    Func = function()
...
GamesGroup:AddToggle("AutoJumpRope", {
    Text = "Auto Jump Rope",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("FreezeRope", {
    Text = "FREEZE ROPE",
    Default = false,
    Callback = function(Value)
        local rope = workspace:FindFirstChild("Effects") and workspace.Effects:FindFirstChild("rope")
...
GamesGroup:AddButton("NOBALANCEMINIGAME", {
...
GamesGroup:AddToggle("AntiFallJumpRope", {
...
GamesGroup:AddToggle("AntiFallPlatformJumpRope", {
...
GamesGroup:AddToggle("AntiFallJumpRope2", {
    Text = "ANTI FALL",
    Default = false,
    Callback = function(Value)
...
GamesGroup:AddToggle("SafePlatform", {
    Text = "SAFE PLATFORM",
    Default = false,
    Callback = function(Value)
        if Value then
...
GamesGroup:AddButton("GlassBridgeTeleportToEnd", {
...
GamesGroup:AddButton("TPENDGlass", {
    Text = "TP END",
    Func = function()
...
GamesGroup:AddButton("GlassBridgeFakeGlass", {
...
GamesGroup:AddToggle("GlassVision", {
    Text = "Glass Vision",
    Default = false,
    Callback = function(Value)
        showGlassESP = Value
...
GamesGroup:AddToggle("GlassPlatforms", {
...
GamesGroup:AddToggle("AntiFallPlatformGlassBridge", {
...
GamesGroup:AddButton("TeleportToRoom", {
...
GamesGroup:AddButton("BringPersonOut", {
...
GamesGroup:AddToggle("AutoMingle", {
    Text = "Auto Mingle",
    Default = false,
    Callback = function(Value)
        _G.AutoMingle = Value
...
GamesGroup:AddToggle("AntiFallSkySquid", {
...
GamesGroup:AddToggle("AutoQTESkySquid", {
...
GamesGroup:AddToggle("SafePlatformSkySquid", {
...
GamesGroup:AddButton("TeleportToFinalGame", {
...
GamesGroup:AddToggle("AntiFallFinal", {
...
GamesGroup:AddButton("TPSAFEPLACELightsOut", {
    Text = "TP SAFE PLACE",
    Func = function()
...
GamesGroup:AddToggle("AutoKillPlayers", {
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                ...
                FollowAllConnection = RunService.RenderStepped:Connect(function()
                    ...
                    if closestPlayer and closestPlayer.Character then
                        local targetTorso = closestPlayer.Character:FindFirstChild("HumanoidRootPart") or closestPlayer.Character:FindFirstChild("UpperTorso") or closestPlayer.Character:FindFirstChild("Torso")
                        if targetTorso then
...
GamesGroup:AddToggle("DontExitSquid", {
...
SettingsGroup:AddDropdown("SelectedConfig", {
    Text = "Select Config",
    Values = Configs,
    Default = "default",
...
SettingsGroup:AddInput("NewConfigName", {
...
SettingsGroup:AddButton("LoadSelected", {
    Text = "Load Selected",
    Func = function()
        ...
        if name then
            ...
            Notification("Error: No config selected!", 3)
        end
    end
})

SettingsGroup:AddButton("SaveConfig", {
    Text = "Save Config",
    Func = function()
        ...
        if name and name ~= "" then
            ...
            Notification("Error: Enter a name or select a config!", 3)
        end
    end
})

SettingsGroup:AddButton("DeleteConfig", {
    Text = "Delete Config",
    Func = function()
        local name = Library.Flags["SelectedConfig"]
        if name and name ~= "" then
            ...
            Notification("Error: Select a config first!", 3)
        end
    end
})

SettingsGroup:AddButton("RefreshList", {
    Text = "Refresh List",
    Func = function()
        local NewList = Library:GetConfigs()
        if Library.Items["SelectedConfig"] then Library.Items["SelectedConfig"].Refresh(NewList) end
        Notification("Configs: List refreshed", 2)
    end
})
...
if Library.ThemePresets then
    ...
    SettingsGroup:AddDropdown("PresetTheme", {
        Text = "Preset Theme",
        Values = ThemeList,
        Default = "Default",
        Callback = function(Value)
...
SettingsGroup:AddInput("WatermarkText", {
    Text = "Watermark Text",
    Default = "NOT HUB [OBSIDIAN UI]",
...
SettingsGroup:AddToggle("GroupboxAnimations", {
    Text = "Groupbox Animations",
    Default = true,
    Callback = function(Value)
...
SettingsGroup:AddButton("UnloadUI", {
    Text = "Unload / Destroy UI",
    Func = function()
...
SettingsGroup:AddLabel("Counter [ "..game:GetService("LocalizationService"):GetCountryRegionForPlayerAsync(game.Players.LocalPlayer).." ]")
SettingsGroup:AddLabel("Executor [ "..identifyexecutor().." ]")
SettingsGroup:AddLabel("Job Id [ "..game.JobId.." ]")

SettingsGroup:AddButton("CopyJobId", {
    Text = "Copy JobId",
    Func = function()
...
SettingsGroup:AddInput("JoinJob", {
    Text = "Join Job",
    Default = "",
...
SettingsGroup:AddButton("JoinJobId", {
    Text = "Join JobId",
    Func = function()
...
SettingsGroup:AddButton("CopyJoinJobId", {
...
KillauraGroup:AddToggle("EnableKillaura", {
    ...
    Callback = function(Value)
        ...
        Notification("Killaura " .. (Value and "Enabled" or "Disabled"))
    end
})

KillauraGroup:AddSlider("KillauraRangeSlider", {
    Text = "Killaura Range",
    Min = 5,
    Max = 30,
    Default = 15,
...
local function FireForkRemote()
    ...
    if fork.Parent == LocalPlayer.Backpack then
        local humanoid = GetHumanoid()
        if humanoid then
...
local function BypassRagdoll()
    ...
    Notification("Ragdoll Bypass Enabled", 3)
end

KillauraGroup:AddToggle("AntiRagdoll", {
    Text = "Anti-Ragdoll",
    Default = false,
    Callback = function(Value)
        if Value then
            ...
            Notification("Anti-Ragdoll Disabled", 3)
        end
    end
})
...
function enableESPCandies()
    ...
    Notification("ESP Candies enabled", 3)
end
...
function disableESPCandies()
    ...
    candyHighlights = {}
    Notification("ESP Candies disabled", 3)
end
...
function enableESPHalloweenDoors()
    ...
    Notification("ESP Halloween Doors enabled", 3)
end
...
function disableESPHalloweenDoors()
    ...
    doorHighlights = {}
    Notification("ESP Halloween Doors disabled", 3)
end
...
function executeLightningGodEffect()
    local character = LocalPlayer.Character
    if not character then return end
...
Notification("NOT HUB LOADED!", 5)
print("NOT HUB LOADED!")
